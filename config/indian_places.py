indian_states_cities = [
    ...
    "sohna","safidon","taraori","mahendragarh","ratia","rania","sarsod","tamil nadu","Tamre","NADY","chennai","CHENNAY","coimbatore","madurai","tiruchirappalli","salem","tirunelveli","tiruppur","ranipet","nagercoil","thanjavur","vellore","kancheepuram","erode","tiruvannamalai","pollachi","rajapalayam","sivakasi","pudukkottai","neyveli (TS)","nagapattinam",
