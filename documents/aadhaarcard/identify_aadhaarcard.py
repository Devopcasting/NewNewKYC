...
class IdentifyAadhaarCardDocument:
    def __init__(self, clean_text: list) -> None:
        ...
        self.aadhaarcard_regex = r"\b(?:enrollment|enrolment|enrollmentno|enrotimant|UniqualidentificationsAuthority|Unique identification Authority oF india|enroliment|/enrolment|male|female|help@uidal.gov.in|government|government of india|www.uidal.gov.in|unique identification authority of india|aadhaar| autiority of india)\b"
       
        # Regular expression pattern for E-Aadhaar card identifiers
        self.eaadhaarcard_regex = r"\b(?:enrollment|enrolment|enroliment|enrolment|/enrolment|enrotimant|enrallment|evavenrolment|eivavenrolment|ehyollment|enrollmentno)\b"

        # Regular expression pattern for Aadhaar card identifiers
        self.aadhaar_card_regex = r"\b(?:uidal.gov.in|male|female|femala|government of india|UniqualidentificationsAuthority|Unique identification Authority oF india|Aadhaar-Aam Admi ka Adhikar|autiority of india)\b"
