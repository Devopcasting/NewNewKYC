...
class IdentifyAadhaarCardDocument:
    def __init__(self, clean_text: list) -> None:
        ...
        # Regular expression pattern for Aadhaar card identifiers
        self.aadhaar_card_regex = r"\b(?:uidal.gov.in|male|female|femala|eemale|government of india|UniqualidentificationsAuthority|MERA AADHAAR  MERI PEHGHAN|Unique identification Authority oF india|Aadhaar-Aam Admi ka Adhikar|autiority of india)\b"
