...
class IdentifyPancardDocument:
    def __init__(self, clean_text: list) -> None:
        ...
        self.pancard_regex = r"\b(?: account|permarent|pefirianent|petmancnt|petraancnt|income|tax|incometax|department|permanent|petianent|incometaxdepartment|incombtaxdepartment|pormanent|perenent|tincometaxdepakinent|fetax|departmen)\b"
