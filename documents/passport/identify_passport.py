...
class IdentifyPassportDocument:
    def __init__(self, clean_text: list) -> None:
        ...
        self.passport_regex = r"(?:republic|posspau|pusepart|passgert|jpassport|pasaport|passport|passpon|ipassport|overseas|citizen|bissport|passoars|passportno|paeupari|paasport)"
