        ...
        if self.db_client is None:
            ...
            try:
                with ThreadPoolExecutor(max_workers=2) as executor:
                    executor.submit(self._query_in_progress_status_doc)
                    executor.submit(self._process_documents)
            except Exception as e:
